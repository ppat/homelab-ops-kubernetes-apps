...
| | [storage-object-core](./infrastructure/subsystems/storage-object-core) | <img src="./.static/images/logos/garage.svg" width="16" height="16" alt="Garage"> <a href="https://garagehq.deuxfleurs.fr/" target="_blank">Garage</a> | • Provides S3-compatible object storage via an operator-managed Garage cluster<br>• Serves opted-in bucket contents anonymously via website hosting<br>• Deployed alongside MinIO as its evaluated replacement |
