...
## [0.1.8](https://github.com/ppat/homelab-ops-kubernetes-apps/compare/apps-bitwarden-v0.1.7...apps-bitwarden-v0.1.8) (2026-09-19)


### 🚀 Enhancements + Bug Fixes

* **apps-bitwarden:** update self-host (2.4.1 -&gt; 2.4.2) ([#4058](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/4058)) ([bb5bd96](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/bb5bd961836526f05939817237f39a406c9c1443))

## [0.1.7](https://github.com/ppat/homelab-ops-kubernetes-apps/compare/apps-bitwarden-v0.1.6...apps-bitwarden-v0.1.7) (2026-09-17)


### 🚀 Enhancements + Bug Fixes

* **apps-bitwarden:** update self-host (2.4.0 -&gt; 2.4.1) ([#4041](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/4041)) ([6be4f53](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/6be4f5318b376d2dfa663c435190ede84834abf5))
...
* **apps-bitwarden:** update self-host (2.3.3 -&gt; 2.4.0) ([#3832](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/3832)) ([b9121b8](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/b9121b861d5a0c38df711d617ab2dbdef0f97bfd))


### 🚀 Enhancements + Bug Fixes

* **apps-bitwarden:** update self-host (2.3.2 -&gt; 2.3.3) ([#3809](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/3809)) ([03cc1a1](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/03cc1a1961679a4d30be892a9990a4960926f7d7))

## [0.1.4](https://github.com/ppat/homelab-ops-kubernetes-apps/compare/apps-bitwarden-v0.1.3...apps-bitwarden-v0.1.4) (2026-08-21)


### ✨ Features

* **apps-bitwarden:** update self-host (2.2.0 -&gt; 2.3.0) ([#3777](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/3777)) ([eaa0852](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/eaa0852ce9207752dd041857fb3e566b9c16af7c))


### 🚀 Enhancements + Bug Fixes

* **apps-bitwarden:** update self-host (2.3.0 -&gt; 2.3.2) ([#3793](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/3793)) ([92c7db6](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/92c7db6fe46f24a44380b40dac8820801d6776a9))
...
* **apps-bitwarden:** update self-host (2.1.1 -&gt; 2.1.2) ([#3545](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/3545)) ([b8ac648](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/b8ac6484019c32e21cb314caaa42dfb3ef0f224b))

## [0.1.1](https://github.com/ppat/homelab-ops-kubernetes-apps/compare/apps-bitwarden-v0.1.0...apps-bitwarden-v0.1.1) (2026-07-25)


### 🚀 Enhancements + Bug Fixes

* **apps-bitwarden:** update self-host (2.1.0 -&gt; 2.1.1) ([#3134](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/3134)) ([0a0772d](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/0a0772d31fbace3de54e6a63802497ae1d4b5523))
...
* **apps-bitwarden:** update self-host (1.1.5 -&gt; 1.1.8) ([#2793](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/2793)) ([a9dd764](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/a9dd764abd7797b51f2fcce71558533f405fcf41))

## [0.0.22](https://github.com/ppat/homelab-ops-kubernetes-apps/compare/apps-bitwarden-v0.0.21...apps-bitwarden-v0.0.22) (2026-03-10)


### 🚀 Enhancements + Bug Fixes

* **apps-bitwarden:** update self-host (1.1.3 -&gt; 1.1.5) ([#2675](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/2675)) ([f39caa4](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/f39caa4375b983823af4d14de208575e940ead1d))

## [0.0.21](https://github.com/ppat/homelab-ops-kubernetes-apps/compare/apps-bitwarden-v0.0.20...apps-bitwarden-v0.0.21) (2026-01-04)


### 🚀 Enhancements + Bug Fixes

* **apps-bitwarden:** update self-host (1.1.1 -&gt; 1.1.2) ([#2591](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/2591)) ([55de736](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/55de73613020c8505ef721455404bf55b73e36de))
* **apps-bitwarden:** update self-host (1.1.2 -&gt; 1.1.3) ([#2603](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/2603)) ([7807b3b](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/7807b3b74c5cf3b82fe11f1ff625144b4d074f9b))
...
* **apps-bitwarden:** update self-host (2025.9.2 -&gt; 2025.10.0) ([#2367](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/2367)) ([7ca37d0](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/7ca37d0e127692f10d0d935ed8254387fe3a3fcb))


### 🚀 Enhancements + Bug Fixes

* **apps-bitwarden:** update self-host (2025.10.0 -&gt; 2025.10.1) ([#2393](https://github.com/ppat/homelab-ops-kubernetes-apps/issues/2393)) ([bc051e0](https://github.com/ppat/homelab-ops-kubernetes-apps/commit/bc051e04d80edaa45b07a990a973c710740924e4))
